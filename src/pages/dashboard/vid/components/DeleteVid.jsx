...
const DeleteVid = ({ handleClose, vidId }) => {
    ...
    const submitForm = async () => {
        setLoading(true)
        await api.delete(appUrls?.VID_URL + `/${Id}`)
        .then((res) => {
            setLoading(false)
  ...
  return (
    <div className='bg-[#fff] w-[300px] h-[200px] mt-[100px] flex flex-col items-center p-8 gap-8 rounded-lg'>
        <p className='text-center text-lg font-medium font-merri '>Are you sure you want to delete this Video?</p>
