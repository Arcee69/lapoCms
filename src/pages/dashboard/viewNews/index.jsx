...
const ViewNews = () => {
    ...
    const [openUpdateNewsPost, setOpenUpdateNewsPost] = useState(false);
    const [updateNewsPost, setUpdateNewsPost] = useState();
  ...
  return (
    <div className='md:p-8 flex flex-col gap-4'>
                                    ...
                                    >
                                        <div className='flex flex-col gap-3 p-3'>
                                            ...
                                            <Link 
                                                ...
                                                state={blog}
                                                className='cursor-pointer hover:bg-[#F8F8F8] p-1'
                                                // onClick={() => {navigate("/update-blog"), setUpdateNewsPost(blog)}}
                                            >
                                                Edit
                                            </Link>
                                        </div>
        ...
        <ModalPop isOpen={openUpdateNewsPost}>
            <UpdateNews
                handleClose={() => setOpenUpdateNewsPost(false)} 
                data={updateNewsPost}
            />
        </ModalPop>
    </div>
